        ...
        <div class="card-body">
          ...
          <form id="formAuthentication" class="mb-6" action="{{url('/register')}}" method="POST">
            ...
            <div class="mb-4">
              ...
              <input type="text" class="form-control @error('name') is-invalid @enderror" id="businessName" name="business_name" placeholder="Enter your business name" required autofocus>
              @error('name')
